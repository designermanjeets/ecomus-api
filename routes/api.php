...
Route::post('/new-payment-response', 'App\Http\Controllers\SabpaisaResponse@NewPaymentResponse')->name('new-payment-response');
Route::post('/check-payment-response', 'App\Http\Controllers\SabpaisaResponse@CheckPaymentResponse')->name('check-payment-response');
Route::get('/test', 'App\Http\Controllers\SabpaisaResponse@test')->name('test');
...
Route::group(['middleware' => ['localization']], function () {
  ...
  Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::put('updateProfile', 'App\Http\Controllers\AccountController@updateProfile');
    Route::put('updatePassword', 'App\Http\Controllers\AccountController@updatePassword');
    Route::post('validPincode', 'App\Http\Controllers\AccountController@validPincode');
    Route::get('allCitiesList', 'App\Http\Controllers\AccountController@allCitiesList');
