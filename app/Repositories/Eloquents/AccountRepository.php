...
class AccountRepository extends BaseRepository
{
    ...
    public function allCities($request){
        
      $query =   DB::table('new_cities')->get();
      $statename =array();
      
      
      foreach ($query as $key=>$user) {
          $query[$key]->NewStateName = $user->StateName;
          $query[$key]->label = $user->StateName;
          $query[$key]->value = $user->StateName;
        
        }
         
       //  return $response = ['status'=>true,'data'=>$query];
    ...
    public function updatePin($request)
    {
           ...
           if($request->StateName){
                ...
                $query = DB::table('new_cities')->where('StateName', '=', $request->StateName)->get();
           ...
           if(isset($query)){
               ...
               return $response = ['status'=>false,'msg'=>'No record Found'];
        ...
        //  $query = DB::table('cities')->where('Pincode', '=', $request->pincode)->first();
            
          
        //   if(isset($query->Pincode)){
              
        //      if($query->City == $request->city){
        ...
        //         return $response = ['status'=>false,'msg'=>'City and Pincode Does not Match'];
