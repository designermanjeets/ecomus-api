...
class EasebuzzRequest extends Controller
{
    public function easebuzzinitiatepayment(Request $request)
    {
        
        $data = '{
            "api_username": "stylexio_easebuzz1051",
            "api_password": "J!mLW0dh"
    ...
    //"amount": "'.$request->total.'",
        if($orderStatus =='1'){
          ...
          $token = $res->token;
            $data = '{
                    ...
                    "pay_mode": "upi_trust",
                    "redirect_url": "https://stylexio.in/account/order",
                    "callback_url": "https://api.fashioncarft.com/public/api/stylexio-webhook-easebuzz" }';
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
            ...
            "APIKey: PnzeirZR3T@byPt@ua23Mp!9Ys32QzFg0eI!XjcWR9!TZfR6hy",
        ]);
       ...
       $newtoken = "Bearer " . $token;
        ...
        DB::table('zp_easebuzz')->insert($insertdata);
    ...
    public function stylexiowebhookeasebuzz(Request $request){
         ...
         DB::table('tbl_stylexiowebhookeasebuzz')->insert($insertdata);
