...
class AccountController extends Controller
{
    ...
    public function validPincode(UpdateProfileRequest $request)
    {
        return $this->repository->updatePin($request);
        
    }
    
     public function allCitiesList(UpdateProfileRequest $request)
    {
        return $this->repository->allCities($request);
